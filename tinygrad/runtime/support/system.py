...
from tinygrad.runtime.support.usb import USB3, CustomASM24Controller, ASM24Controller, USBMMIOInterface, asm24_gpu_bus
...
class USBPCIDevice(PCIDevice):
  def __init__(self, devpref:str, dev, pcibus):
    ...
    self.gpu_bus = asm24_gpu_bus(usb.usb_id)
